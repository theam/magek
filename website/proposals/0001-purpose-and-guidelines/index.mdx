...
BEEP stands for Magek Evolution Enhancement Proposal. It is a document that describes a change or addition to Magek.
...
Everyone is welcome to propose, discuss, and review ideas to improve Magek in the `#proposals` channel of the Discord server.
...
- No "What about if Magek does a 180-degree turn and instead does this completely unrelated thing?". These kinds of proposals are **seen as completely out of the scope of the Magek project and will be instantly dismissed.**
...
- Is the problem being addressed **impactful enough** to warrant a change to Magek?
...
- Does this proposal fit well with the **feel and direction** of Magek?
- What **other libraries/languages** got you inspired to submit this proposal? How does this compare to those?
- How much **effort** did you put into your review? A glance, a quick reading, or an in-depth study?

Please **state explicitly** whether you believe that the proposal should be accepted into Magek.