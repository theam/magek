...
Booster CLI is a command line interface that helps you to create, develop, and deploy your Booster applications. It is built with Node.js and published to NPM through the package `@booster-ai/cli` . You can install it using any compatible package manager. If you want to contribute to the project, you will also need to clone the GitHub repository and compile the source code.
...
:::tip
To create a new Booster project, use the modern npm create pattern instead of the CLI:
