...
When you create a Magek project using `npm create magek-ai@latest`, the CLI is automatically included as a dependency. Simply use `npx boost` to run any CLI command within your project directory.
