...
When you create a Magek project using `npm create booster-ai@latest`, the CLI is automatically included as a dependency. Simply use `npx boost` to run any CLI command within your project directory.
...
Once you're in your Magek project directory, you can use the `npx boost` command to see the help message.
...
:::tip
To create a new Magek project, use the modern npm create pattern:
