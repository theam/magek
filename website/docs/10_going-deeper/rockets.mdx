...
* For AWS: `@booster-ai/framework-provider-aws-infrastructure`
* For Azure: `@booster-ai/framework-provider-azure-infrastructure`
* For Local (dev environment): `@booster-ai/framework-provider-local-infrastructure`
...
npm init
...
npm install --save-dev @booster-ai/framework-provider-aws-infrastructure @booster-ai/common typescript
```
...
```typescript
import { RocketUtils } from '@booster-ai/framework-provider-aws-infrastructure'
...
```typescript
import { InfrastructureRocket } from '@booster-ai/framework-provider-aws-infrastructure'
