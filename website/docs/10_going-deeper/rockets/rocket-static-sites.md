...
:::info
[GitHub Repo](https://github.com/magekcloud/rocket-static-sites-aws-infrastructure)
:::
...
## Usage
 ...
 ```bash
 npm install --save-dev @magek-ai/rocket-static-sites-aws-infrastructure
 ```
...
Magek.configure('development', (config: MagekConfig): void => {
  ...
  config.rockets = [
    {
      packageName: '@magek-ai/rocket-static-sites-aws-infrastructure', 
      parameters: {
