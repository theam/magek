...
❯ @booster-ai/server (Booster Server)
```

</TerminalWindow>

When asked for the provider, choose **Booster Server**, which allows you to run and debug your application locally.
