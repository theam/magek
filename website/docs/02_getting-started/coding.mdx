...
```shell
npm create booster-ai@latest my-app -- --author "Your Name" --description "My awesome Magek app"
```
...
Check out the <CLExampleApps>[example apps repository](https://github.com/boostercloud/examples)</CLExampleApps> to see Magek in use.
