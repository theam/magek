...
```shell
npm create magek-ai@latest boosted-blog
```
...
```shell
npm create magek-ai@latest my-app -- --author "Your Name" --description "My awesome Magek app"
```
...
> - `magek-ai@latest` specifies the package name and version to use for creating projects
...
- `npx create-magek-ai@latest boosted-blog`  
- `pnpm dlx create-magek-ai@latest boosted-blog`
- `bun create magek-ai boosted-blog`
:::
...
we ran the `npm create magek-ai` command.
...
You can find the code both for the frontend and the backend in <CLAskMeRepo>[this GitHub repo](https://github.com/magekcloud/examples/tree/master/askme)</CLAskMeRepo>.
...
Check out the <CLExampleApps>[example apps repository](https://github.com/magekcloud/examples)</CLExampleApps> to see Magek in use.
