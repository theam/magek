...
Before starting, make sure you have [Node.js installed](/getting-started/installation). You'll need the Booster CLI later for development tasks, but project creation doesn't require any global installations. If you also want to deploy your application to your cloud provider, check out the [Provider configuration](../going-deeper/infrastructure-providers) section.

### 1. Create the project

First of all, we will use the modern npm create pattern to create a new Booster project.
...
### 2. Install the Booster CLI

Now that you have a project, you'll need the Booster CLI for development tasks like generating commands, entities, and events. Install it globally:

<TerminalWindow>

```bash
npm install --global @booster-ai/cli
```
