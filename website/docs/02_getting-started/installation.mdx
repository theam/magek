...
import {CLInstallMagek} from '@site/src/components/CustomLinkWrappers'
...
:::info
For more information on upgrades between Magek v2.x.x and v3.x.x, read [this page](https://github.com/boostercloud/booster/blob/main/upgrade-v3.md).

For more information on upgrades between Magek v1.x.x and v2.x.x, read [this page](https://github.com/boostercloud/booster/blob/main/upgrade-v2.md).
:::
...
Verify the Magek CLI installation with the `npx boost version` command. You should get back something like
...
:::tip
The CLI is automatically included in every Magek project - no global installation needed! Use `npx boost` for all CLI commands within your project directory.
:::
