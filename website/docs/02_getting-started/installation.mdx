...
:::info
For more information on upgrades between Magek v2.x.x and v3.x.x, read [this page](https://github.com/magekcloud/magek/blob/main/upgrade-v3.md).

For more information on upgrades between Magek v1.x.x and v2.x.x, read [this page](https://github.com/magekcloud/magek/blob/main/upgrade-v2.md).
:::
...
```shell
npm create magek-ai@latest my-project
```
...
When you create a project using `npm create magek-ai@latest`, the CLI is added as a dependency and can be used immediately:
