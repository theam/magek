...
```typescript
import { Booster, NonExposed, Query } from '@booster-ai/core'
import { QueryInfo, QueryInput, UserEnvelope, UUID } from '@booster-ai/common'
...
```shell
npx boost new:query ItemsInCountry --fields country:string
```
