...
import { Notification } from '@booster-ai/framework-core'
...
As you can see, to define a notification you simply need to import the `@Notification` decorator from the @booster-ai/framework-core library and use it to decorate a class. In this case, the class `CartAbandoned` represents a notification that informs interested parties that a cart has been abandoned.
...
import { Notification, partitionKey } from '@booster-ai/framework-core'
