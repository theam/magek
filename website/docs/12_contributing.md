...
Go ahead and ask the community in [Discord](https://discord.com/invite/bDY8MKx) or [create a new issue](https://github.com/magekcloud/magek/issues).
...
The packages are published to `npmjs` under the prefix `@magek-ai/`, their purpose is as follows:
...
- Clone the repo and get into the directory of the project: `git clone <WRITE REPO URL HERE> && cd magek`
