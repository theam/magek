...
import { Magek, JwksUriTokenVerifier } from '@magek-ai/core'
...
```typescript title="src/config/config.ts"
import { Magek, PublicKeyTokenVerifier } from '@magek-ai/core'
import { MagekConfig } from '@magek-ai/common'
...
```typescript title="src/config/config.ts"
import { Magek, TokenVerifier } from '@magek-ai/core'
import { MagekConfig, DecodedToken, TokenVerifier, UserEnvelope } from '@magek-ai/common'
