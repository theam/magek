...
<TabItem value="magek-config" label="Magek Config" default>
...
<TabItem value="magek-command" label="Magek Command">
...
<TabItem value="magek-roles" label="Magek Roles">
...
### Extended roles using the [Authentication Magek Rocket for AWS](https://github.com/magekcloud/rocket-auth-aws-infrastructure)
...
To learn more about the Authorization rocket for AWS, please read the [README](https://github.com/magekcloud/rocket-auth-aws-infrastructure/blob/main/README.md) in its Github repository.
