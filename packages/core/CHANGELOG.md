...
- Include request context (headers, body) in read model request envelopes so authorizers can access HTTP headers

### Updates

- chore(deps-dev): bump @types/node from 22.19.7 to 22.19.8
- Remove unused dependencies and fix filename typo
