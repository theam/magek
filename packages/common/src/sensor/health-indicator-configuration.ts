...
export enum MAGEK_HEALTH_INDICATORS_IDS {
  ROOT = 'booster',
...
> = {
  [MAGEK_HEALTH_INDICATORS_IDS.ROOT]: { ...DEFAULT_HEALTH_CONFIGURATION_BOOSTER },
  [MAGEK_HEALTH_INDICATORS_IDS.FUNCTION]: { ...DEFAULT_HEALTH_CONFIGURATION_BOOSTER },
  [MAGEK_HEALTH_INDICATORS_IDS.DATABASE]: { ...DEFAULT_HEALTH_CONFIGURATION_BOOSTER },
  [MAGEK_HEALTH_INDICATORS_IDS.DATABASE_EVENTS]: { ...DEFAULT_HEALTH_CONFIGURATION_BOOSTER },
  [MAGEK_HEALTH_INDICATORS_IDS.DATABASE_READ_MODELS]: { ...DEFAULT_HEALTH_CONFIGURATION_BOOSTER },
  [MAGEK_HEALTH_INDICATORS_IDS.ROCKETS]: { ...DEFAULT_HEALTH_CONFIGURATION_BOOSTER },
}
...
export interface SensorBoosterHealthConfiguration {
  ...
  booster: {
    [MAGEK_HEALTH_INDICATORS_IDS.ROOT]: SensorBoosterHealthConfigurationDetails
    [MAGEK_HEALTH_INDICATORS_IDS.FUNCTION]: SensorBoosterHealthConfigurationDetails
    [MAGEK_HEALTH_INDICATORS_IDS.DATABASE]: SensorBoosterHealthConfigurationDetails
    [MAGEK_HEALTH_INDICATORS_IDS.DATABASE_EVENTS]: SensorBoosterHealthConfigurationDetails
    [MAGEK_HEALTH_INDICATORS_IDS.DATABASE_READ_MODELS]: SensorBoosterHealthConfigurationDetails
    [MAGEK_HEALTH_INDICATORS_IDS.ROCKETS]: SensorBoosterHealthConfigurationDetails
  }
}
