---
description: Documentation for defining notifications in the Magek Framework using the @Notification and @partitionKey decorators.
---
...
import { Notification } from '@magek/core'
...
import { Notification, partitionKey } from '@magek/core'
